			...
			<div className="flex">
				<Box className="p-4 my-4">
					<div className="flex items-center justify-center mb-4">
						<div className="w-40 h-40 rounded-full overflow-hidden shadow-lg shadow-gray-800">
							<img
					...
					<Tabs
						...
						className="border-r border-gray-300 w-60 justify-start shadow-2xl shadow-gray-200"
					>
						<Tab
							label="Profile"
